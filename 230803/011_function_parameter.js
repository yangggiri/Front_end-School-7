...
test(b = 100, c = 200) //왜 310이 아니고 330인가요? > 자스는 값을 순서대로 넣습니다
...
//위 문제와 아래 문제를 해결하기 위해 RORO 기법을 사용할 수 있습니다
...
//아래와 같이 작성되기 때문에 2번쨰 문제 해결, 순서도 상관없음
player({
    scene: '플레이신',
    x: 100,
    y: 200,
...
//기본값 설정하는 방법
function player({ scene, x = 0, y = 0, texture, animKey, initHp, dropRate = 0.1 }) {
